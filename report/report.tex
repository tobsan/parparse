...
\end{code}
\caption{The Mat type with its dependent Shape type. Note that shapes are used
both for x-axis and y-axis size}
\end{figure}
...
\caption{\texttt{merge} with and without a single element as glue}
\label{mergein}
\end{figure}
