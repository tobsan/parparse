...
lexer can be generated. The parser uses a tree structure, which, together with
the CYK algorithm, would make it suitable for an implementation utilising
parallelism.
...
two issues will definately have to be dealt with. 
% TODO: Complete this. 
